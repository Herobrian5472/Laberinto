...
class PARED(pygame.sprite.Sprite):
    def __init__(self, x, y):
        ...
        self.rect.y = BALDOSA_TAMANIO * y + MARCADOR_ALTURA
...
class OBJETO(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.rect = self.image.get_rect()
        self.rect.y = random.randint(0, BALDOSA_NUMERO - 1) * BALDOSA_TAMANIO + MARCADOR_ALTURA
...
class PERSONAJE(pygame.sprite.Sprite):
    ...
    def update(self):
        ...
        for object in LISTA_COLISION_OBJETO:
            object.kill()
